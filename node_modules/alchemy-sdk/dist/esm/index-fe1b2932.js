    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield import('./alchemy-provider-ff61e9d1.js');
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield import('./alchemy-websocket-provider-4afa2e9f.js');
...
export { AlchemySubscription as A, CustomNetworks as C, DEFAULT_ALCHEMY_API_KEY as D, EthersNetwork as E, GasOptimizedTransactionStatus as G, IS_BROWSER as I, Network as N, RefreshState as R, TokenBalanceType as T, VERSION as V, Wallet as W, __awaiter as _, DEFAULT_NETWORK as a, getAlchemyWsUrl as b, Alchemy as c, Contract as d, ContractFactory as e, fromHex as f, getAlchemyHttpUrl as g, AssetTransfersCategory as h, isHex as i, AssetTransfersOrder as j, NftTokenType as k, logWarn as l, NftSpamClassification as m, noop as n, NftExcludeFilters as o, WebhookVersion as p, WebhookType as q, setLogLevel as s, toHex as t };
//# sourceMappingURL=index-fe1b2932.js.map
